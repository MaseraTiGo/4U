...
class FccKingTax:
    ...
    def __init__(self, old_ratio=.08, medical_ratio=.00875,
                 unemployment_ratio=.003,
                 house_funding_ratio=.12,
                 insurance_upper_bound=8000,
                 house_found_upper_bound=8000):
...
if __name__ == '__main__':
    ...
    salary = 17710
    income = salary * 12
    tax_per_month = ft.get_new_tax(salary, 5000)
