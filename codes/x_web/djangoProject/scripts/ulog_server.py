...
def stop_server(interval=0.1):
    global HTTP_HANDLER
    redis_op = RedisBase(REDIS_CONF)
    while 1:
        ret = redis_op.get(f'system:ulog_server')
        ...
        if ret is not None:
            if HTTP_HANDLER:
                try:
                    ...
                    print(f"dong ----------------> shutdown ulog http server.")
                    break
...
if __name__ == '__main__':
    ...
    threading.Thread(target=test, kwargs={
