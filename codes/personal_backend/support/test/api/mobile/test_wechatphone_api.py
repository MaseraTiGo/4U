...
#         pass
#
#     def test_wechat_phone_search(self):
#         """ test wechat_mobile_phone to search """
#         api = "mobile.wechatphone.search"
#         current_page = 1
#         search_info = json.dumps({
#
#
#         })
#         result = self.access_api(api = api, current_page=current_page, search_info=search_info)
#         self.assertTrue('data_list' in result)
#         print('---------------------->', result['data_list'])


# class RemoveAll(APITestCase):
#
#     def setup(self):
#         pass
#
...
#         pass
#
#     def test_wechat_phone_remove(self):
#         """ test wechat_mobile_phone to search """
#         api = "mobile.wechatphone.removeall"
#         mobile_phone_id = 3
#         result = self.access_api(api = api, mobile_phone_id=mobile_phone_id)
#         #self.assertTrue('data_list' in result)
#         print('---------------------->', result)
...
#         pass
#
#     def test_wechat_phone_add(self):
#         """ test wechat_mobile_phone to add """
#         api = "mobile.wechatphone.add"
#         mobile_phone_info = json.dumps({
#             'leader': 'fucking test!!!'
#
#         })
...
class Update(APITestCase):
    ...
    def test_wechat_phone_add(self):
        """ test wechat_mobile_phone to update """
        api = "mobile.wechatphone.update"
        mobile_phone_id = 1
        mobile_phone_info = json.dumps({
            'phone_remark': 'my eyes are very pain',
            'brand': 'win-fly'

        })
        result = self.access_api(api = api, mobile_phone_id=mobile_phone_id, mobile_phone_info=mobile_phone_info)
        #self.assertTrue('data_list' in result)
        print('---------------------->', result)