...
class NetEaseConfig(Config):
    classify = 'netease_sms'
    ...
    def config_details_mapping(self):
        return {
            (self.classify, 'appkey', '短信appkey'): {},
            (self.classify, 'appsecret', '短信appsecret'): {},
